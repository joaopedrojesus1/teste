...
<head>
    ...
    <title>Lista</title>
    <link rel="stylesheet" href="../listar_funcionario/estilo.css">
...
<h1 id="h1">Lista de Funcionários</h1>
    <div>
    <?php
        $result_pg= "SELECT COUNT(id) AS num_result FROM admin WHERE status = '2'";
        $resultado_pg= mysqli_query($conn, $result_pg);
        $row_pg = mysqli_fetch_assoc($resultado_pg);

        echo "<p id='quantidade'>Quantidade de funcionários: " . $row_pg["num_result"] . "</p><br>";
        ...
        $result_usuarios = "SELECT * FROM admin WHERE status = '2' LIMIT $inicio, $qnt_result_pg";
        $resultado_usuarios = mysqli_query($conn, $result_usuarios);
        while($row_usuario = mysqli_fetch_assoc($resultado_usuarios)){
            echo "<div id= div1>";
            echo "<img id=imagem src='img/imagemperfil.png'>"; 
            
            echo "<a id= nomePLACA>";
            echo "ID: " . $row_usuario['id'];
            echo "<br>" . "Usuário: " . $row_usuario['usuario'] . "<br>";
            echo "</a>";

            echo "<a href='proc_apagar_funcionario.php?id="  . $row_usuario['id'] . "' class= 'final'> Demitir</a>";
            echo "<a href='edit_funcionario.php?id="  . $row_usuario['id'] . "' class= 'final'> Editar</a>";
            echo "</div> <br><br>";
            
            
        }
        //Parte do CADASTRAR(LISTA)
        echo "<a id= 'cadastrar' href='../login e cadastros/cadastro_funcionario.php'>Cadastrar</a><br><br>";
