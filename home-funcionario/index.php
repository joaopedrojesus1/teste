...
?>
	...
	<div class="col-md-3 col-sm-4">
      <div class="wrimagecard wrimagecard-topimage">
          <a href="../listar_automovel_funcionario/index.php">
  ...
  <div id="footer">
    ...
    <footer style="background-color: #FAA510;" class="d-flex flex-wrap justify-content-between align-items-center py-3  border-top" id="rodape">
      ...
      <ul class="nav col-mc-4 justify-content-end">
        <li class="nav-item"><a href="../home-funcionario/index.php" class="nav-link px-2" id="home" style="font-size: 14px; color: #FFF;">Início</a></li>
